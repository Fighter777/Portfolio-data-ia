...
- `badges/` : badges de statut générés localement.

Les identifiants SVG simplifiés ne prétendent pas remplacer les marques ou logos officiels des produits concernés ; ils servent uniquement à identifier visuellement la stack utilisée dans le portfolio.
